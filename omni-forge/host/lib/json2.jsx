/**
 * JSON2 polyfill for ExtendScript (which has no native JSON object).
 * Public domain - Douglas Crockford's reference implementation, trimmed.
 */
  ...
  if (typeof JSON.parse !== "function") {
    JSON.parse = function (text, reviver) {
      ...
      if (rx_escapable.test(text)) {
        text = text.replace(rx_escapable, function (a) { return "\\u" + ("0000" + a.charCodeAt(0).toString(16)).slice(-4); });
      }
